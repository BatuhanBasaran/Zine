...
class cRequestHandler:
        ...
        try:
            ...
            if e.code >= 400:
                ...
                if 'DDOS-GUARD' in str(data):
                    ...
                    if not self.ignoreErrors:
                        xbmcgui.Dialog().ok('Zine', cConfig().getLocalizedString(30259) + ' {0} {1}'.format(self._sUrl, str(e)))
    ...
    def clearCache(self):
        ...
        for file in files:
            ...
            xbmcgui.Dialog().notification('Zine', cConfig().getLocalizedString(30405), xbmcgui.NOTIFICATION_INFO, 100, False)
