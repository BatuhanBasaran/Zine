...
# Domain Abfrage
DOMAIN = cConfig().getSetting('plugin_' + SITE_IDENTIFIER + '.domain', 'archive.org') # Domain Auswahl über die Zine Einstellungen möglich
...
def showCollections(entryUrl=False, sGui=False):
    ...
    # Filter nach eingestellter Sprache in Zine laden
